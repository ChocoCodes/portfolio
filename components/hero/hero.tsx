        ...
        >
            <div className="flex justify-between items-center">
                <div className="flex gap-3 items-center">
                    <Image src='/img/profile-octavio.jpg' alt="Image of John Octavio" width={64} height={64} className='object-cover rounded-sm'/>
            ...
            <p className="inline-flex gap-1 text-[8px] lg:text-lg items-center font-manrope text-secondary"> <GrLocationPin /> Bacolod City, Philippines</p>
